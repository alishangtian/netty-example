...
package com.alishangtian.nettyexample.http2.tiles;
...
import static com.alishangtian.nettyexample.http2.Http2ExampleUtil.firstValue;
import static com.alishangtian.nettyexample.http2.Http2ExampleUtil.toInt;
...
/**
 * Handles all the requests for data. It receives a {@link FullHttpRequest}, which has been converted by a {@link
 * InboundHttp2ToHttpAdapter} before it arrived here. For further details, check {@link Http2OrHttpHandler} where the
 * pipeline is setup.
 */
