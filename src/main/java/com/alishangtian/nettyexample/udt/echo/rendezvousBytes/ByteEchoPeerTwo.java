 ...
 * under the License.
 */
package com.alishangtian.nettyexample.udt.echo.rendezvousBytes;

import com.alishangtian.nettyexample.udt.echo.rendezvous.Config;
 ...
 * client initiates the ping-pong traffic between the echo client and server by sending the first message to the
 * server.
 * <p/>
 */
